...
<head>
  ...
  $linha =$obj->unidademedida_select_table();
  //Select último produto
  $ultimo = $obj->unidademedida_select_ultimo();
  //popula campos no alterar
  $campoalterar = $obj->unidademedida_select($id);
  ?>
</head>
<body class="bg-light">
  ...
  <div class="row">
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h4 class="h4">Unidade de Medida</h4>
      ...
      <div class="card-body">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cadastrar Unidade de Medida</h5>
              ...
              <?php
              require('cadastrar_unidademedida.php');
              ?>
            </div>
          </div>
        </div>
        <div class="modal fade" id="modalalterar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modalalterar">Alterar Unidade de Medida</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <?php
              require('alterar_unidademedida.php');
              ?>
            </div>
          </div>
        </div>
       ...
       <table class="table" id=tabela> 
        ...
        <tbody>
         ...
         while ($i < count($linha)) {
          ...
          <td>
            <a data-toggle="tooltip" data-placement="top" onclick="return confirm('Tem certeza que deseja excluir?');" class="btn btn-danger btn-lg" title="Excluir" href="classes/unidademedida_delete.php?id=<?php echo $linha[$i]['id']?>"> 
